...
import { LogOut, TrendingUp, DollarSign, Users, FileText, Search, RefreshCw, CheckCircle2, XCircle, ExternalLink, Eye, Pencil, Power, BadgeCheck, CalendarDays } from 'lucide-react';
...
const PartnerDashboard = () => {
    ...
    const fetchDashboardStats = async (id) => {
        ...
        try {
            ...
            console.error('Error loading partner dashboard stats', err);
        } finally {
    ...
    useEffect(() => {
        ...
        if (savedData) {
            ...
            if (resolvedId) {
                ...
                fetchDashboardStats(resolvedId);
            }
        }
    }, []);
    ...
    useEffect(() => {
        ...
        fetchDashboardStats(partnerInfo.id);
    }, [partnerInfo?.id, statsRange.mode, statsRange.preset, statsRange.month, statsRange.from, statsRange.to]);
    ...
    const reviewPendingBill = async (billId, decision) => {
        ...
        try {
            ...
            await fetchDashboardStats(partnerInfo.id);
        } catch (_error) {
        ...
        <div className="partner-container">
            ...
            <div className="top-partner-strip">
                ...
                <div className="top-strip-actions">
                    ...
                    <div className="top-action-icons">
                        ...
                        <button className="action-icon-btn refresh-btn" onClick={() => { fetchData(partnerInfo.id); fetchPendingBills(partnerInfo.id); fetchDashboardStats(partnerInfo.id); }} title="Refresh">
                            <RefreshCw size={18} />
                        </button>
            ...
            <div className="dashboard-filters">
                <div className="dashboard-filters-left">
                    <span className="dashboard-filter-icon"><CalendarDays size={16} /></span>
                    <select
            ...
            <div className="stats-grid">
                <div className="stat-card stat-revenue">
                    ...
                    <small className={revenueChange >= 0 ? 'text-green' : ''}>{revenueChangePrefix}{revenueChange.toFixed(1)}% {statsChange.revenueLabel}</small>
                ...
                <div className="stat-card stat-discount">
                    ...
                    <h2>{formatCurrency(stats.discounts)}</h2>
                ...
                <div className="stat-card stat-transactions">
                    ...
                    <div className="stat-header"><span>Total transactions</span> <span className="stat-icon customers"><FileText size={18} color="#2563eb" /></span></div>
                ...
                <div className="stat-card stat-avgbill">
                    ...
                    <h2>{formatCurrency(stats.avgBill)}</h2>
